...
class CollectPoseRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CollectPoseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CollectPoseRequest
    let len;
    let data = new CollectPoseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CollectPoseRequest(null);
...
class CollectPoseResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CollectPoseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CollectPoseResponse
    let len;
    let data = new CollectPoseResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CollectPoseResponse(null);
...
module.exports = {
  Request: CollectPoseRequest,
  Response: CollectPoseResponse,
  md5sum() { return 'a9485893dad130c910b7cc6b86bb0941'; },
  datatype() { return 'iiwa_msgs/CollectPose'; }
};
